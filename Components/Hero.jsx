...
const Hero = ({ titleData, createCampaign }) => {
  ...
  return (
    <div className="relative">
      ...
      <img
        src="https://images.pexels.com/photos/3228766/pexels-photo-3228766.jpeg?auto-compress&amp;cs=tinys rgb&amp; dpr=2&amp;h=750&amp;w=1260"
            ...
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >
                  <path d="M9.707,5.2931-5-5A1,1,0,0,0,3.293, 1.707L7.586,6,3.293,10.2" />
                </svg>{" "}
              </a>
            </div>
                ...
                <form>
                  ...
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="date"
                      className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm focus:border-deep-purple-accent-400 appearance-none focus:outline-none focus:shadow-outline"
                      id="deadline"
                      name="deadline"
                    />
                  </div>
